...
<div class="grid gap-6 md:grid-cols-2 items-start">
    <div class="space-y-4">
        <p class="text-sm text-slate-500">Nama: {{ $qr->name }}</p>
        ...
        <div class="flex flex-wrap gap-3">
            ...
            <a href="{{ route('qr.download', $qr->id) }}" class="px-4 py-2 rounded-lg border border-slate-200 text-slate-700 hover:border-slate-300">Unduh SVG</a>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm flex flex-col items-center">
        <div class="w-60 h-60" aria-hidden="true">{!! $qrSvg !!}</div>
